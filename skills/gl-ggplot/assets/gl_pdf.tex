...
% default to the text-cut shapes. See followups.md #3.

% ---- Fonts ------------------------------------------------------------------

\usepackage{fontspec}

\setmainfont{InterVariable}[
  Path           = /home/taimur/dev/gl-design/assets/fonts/inter/ttf/,
  Extension      = .ttf,
  UprightFont    = *,
  ItalicFont     = *-Italic,
  BoldFont       = *,
...
\newfontfamily\glserif{SourceSerif4Variable-Roman}[
  Path           = /home/taimur/dev/gl-design/assets/fonts/source-serif-4/ttf/,
  Extension      = .ttf,
  UprightFont    = *,
  ItalicFont     = SourceSerif4Variable-Italic,
  BoldFont       = *,
  BoldItalicFont = SourceSerif4Variable-Italic
]

\setmonofont{JetBrainsMono}[
  Path           = /home/taimur/dev/gl-design/assets/fonts/legacy/jetbrains-mono/ttf/,
  UprightFont    = *-Regular,
  BoldFont       = *-Bold,
  ItalicFont     = *-Italic,
